...
<div class="container content">
        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <form id="register-form" action="" method="POST" role="form" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-3">
                                                <input type ="submit" class="form-control btn btn-register" name="regbutton" value="Register">
                                            </div>
                                        </div>
                                    </div>
                                    <!--
            ...
            </div>      <input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Register Now">
